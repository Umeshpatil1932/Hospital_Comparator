...
public class Hospital_dataList {
    public static void main(String[] args) throws InterruptedException {
        ...
        list.add(new Hospital(1, "Umesh", "Pramod", "Ophthalmology:", 1210, 5000));
        list.add(new Hospital(4, "Tushar", "Rohan", "Cardiology:", 1619, 9000));
        list.add(new Hospital(5, "Aniket", "Punam", "Endocrinology:", 1005, 400));
        list.add(new Hospital(3, "Rohit", "Parag", "Gastroenterology:", 1008, 8000));
        list.add(new Hospital(6, "Megraj", "Pavan", "Oncology:", 1003, 7000));
        list.add(new Hospital(2, "Ankush", "Gambhir", "surgen:", 10101, 8100));
